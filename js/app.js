...
// Start Mission 
const cameraimgs = document.querySelector('.cameraimgs');
const missiontexts = document.querySelector('.missiontexts');
...
window.addEventListener('scroll',()=>{
    ...
    if(getscrolly >= 650){
        cameraimgs.classList.add('fromlefts');
        missiontexts.classList.add('fromrights');
    }else{
        cameraimgs.classList.remove('fromlefts');
        missiontexts.classList.remove('fromrights');
    }
});
// End Mission 
...
gallerylists.forEach((gallerylist)=>{
    ...
    gallerylist.addEventListener('click',(e)=>{
        ...
        gallerylist.classList.add('activeitems');
